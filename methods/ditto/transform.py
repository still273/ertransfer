...
def transform_input(source_dir, add_test_data, output_dir, columns_to_join=None, separator=' ',
                    prefixes=['tableA_', 'tableB_'], full_train_input=None, full_add_test=False):
...
def transform_output(scores, threshold, results_per_epoch, ids, labels,preprocess_time, train_time, eval_time, test_input, train_size, dest_dir):
    """
